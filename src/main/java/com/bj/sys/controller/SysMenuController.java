...
public class SysMenuController extends AbstractController {
	...
	public List<SysMenuEntity> list(){
		...
		for(SysMenuEntity sysMenuEntity : menuList){
			sysMenuEntity.setName(sysMenuEntity.getMenuName());
	...
	private void verifyForm(SysMenuEntity menu) throws Exception{
		...
		//菜单
		if(menu.getMenuType() == CommonEnum.MenuType.MENU.getValue()){
		...
		//目录、菜单
		if(menu.getMenuType() == CommonEnum.MenuType.CATALOG.getValue() ||
				menu.getMenuType() == CommonEnum.MenuType.MENU.getValue()){
		...
		//按钮
		if(menu.getMenuType() == CommonEnum.MenuType.BUTTON.getValue()){
