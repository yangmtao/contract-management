...
import com.bj.config.IDKeyGeneratorConfig;
...
public class SnowflakeIdWorker {
    ...
    public  static synchronized SnowflakeIdWorker getInstance(){
        if(idWorker == null){
            ...
            IDKeyGeneratorConfig idGeneratorConfig=  ApplicationContextUtil.getBean(IDKeyGeneratorConfig.class);
            idWorker=new SnowflakeIdWorker(idGeneratorConfig.getWorkerId(),idGeneratorConfig.getDataCenterId());
        }
        return idWorker;
    }
