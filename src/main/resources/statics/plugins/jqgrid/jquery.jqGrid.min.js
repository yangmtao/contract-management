                ...
                var
                    x, y = ["shiftKey", "altKey", "ctrlKey"], z = function (a, b) {
                        ...
                        if (!d.grid.hDiv.loading) {
                            ...
                            switch (b = d.p.datatype.toLowerCase()) {
                                case"postdata":
                                    ...
                                    var arr=d.p.postData!=null &&d.p.postData.length>0?Object.keys(d.p.postData):[];
                                    var postData2={};
                                    postData2["url"]=d.p.url;
                                    if(arr.length>0){
                                        for(var i=0;i<arr.length;i++){
                                            postData2[arr[i]]=d.p.postData[arr[i]];
                                        }
                                    }
                                    ...
                                    //     ...d.p.postData
                                    // });
                                    var postData = JSON.stringify(postData2);
                                    $.ajax($.extend({
                                        url: 'api/postData',
                                        type: d.p.mtype,
                                        contentType:'application/json',
                                        data: $.isFunction(d.p.serializeGridData) ? d.p.serializeGridData.call(d, postData) : postData,
                        ...
                        if (a = a.substr(1), b += "_" + a, c = "pg_" + a, e = a + "_left", f = a + "_center", g = a + "_right", $("#" + $.jgrid.jqID(a)).append("<div id='" + c + "' class='ui-pager-control' role='group'><table " + k(l, "pagerTable", !1, "ui-pg-table ui-common-table ui-pager-table") + "><tbody><tr><td id='" + e + "' align='left'></td><td id='" + f + "' align='center' style='white-space:pre;'></td><td id='" + g + "' align='right'></td></tr></tbody></table></div>").attr("dir", "ltr"), d.p.rowList.length > 0) {
                            t = '<td dir="' + h + '">', t += "<select style='width:100%;' " + k(l, "pgSelectBox", !1, "ui-pg-selbox") + ' role="listbox" title="' + ($.jgrid.getRegional(d, "defaults.pgrecs", d.p.pgrecs) || "") + '">';
                            var
                                v;
